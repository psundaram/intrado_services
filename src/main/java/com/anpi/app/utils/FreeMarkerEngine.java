...
public class FreeMarkerEngine extends TemplateEngine {
    ...
    public String render(ModelAndView modelAndView) {
        try {
            ...
            System.out.println("mdel" + modelAndView.getModel());
     ...
     * Note: If no configuration is set the default configuration will be used where
    ...
    private Configuration createDefaultConfiguration() {
        ...
        configuration.setClassForTemplateLoading(FreeMarkerEngine.class, "/public/");
