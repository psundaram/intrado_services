...
public class VuiBeanResponse {
	...
	public String toString() {
		return "VuiBeanResponse [queryID=" + queryID + ", levelOfService=" + levelOfService + ", CLS=" + CLS + ", CPN=" + CPN + ", ALT=" + ALT + ", RC1=" + RC1 + ", HNO=" + HNO + ", ver=" + ver + ", MCN=" + MCN + ", TAR=" + TAR + ", STA=" + STA
				+ ", TYS=" + TYS + ", ZIP=" + ZIP + ", CPF=" + CPF + ", ORD=" + ORD + ", MTN=" + MTN + ", CPD=" + CPD + ", STN=" + STN + ", ESN=" + ESN + ", CUS=" + CUS + ", NAM=" + NAM + ", externalKey=" + externalKey + ", externalKeyType="
				+ externalKeyType + ", classOfService=" + classOfService + ", typeOfService=" + typeOfService + ", message=" + message + ", content=" + content + "]";
	}
